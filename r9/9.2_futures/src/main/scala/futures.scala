...
package object futures {
   ...
   *
   */
  def incrementF(z: Future[Int]): Future[Int] = ???
   ...
   *
   */
  def sumF(x: Future[Int], y: Future[Int]): Future[Int] = ???
  ...
  object ServicesF {
    def A(x: Future[Int]): Future[Int] = ???
    def B(x: Future[Int]): Future[Int] = ???
    def C(x: Future[Int]): Future[Int] = ???
    def D(x: Future[Int]): Future[Int] = ???
    def E(x: Future[Int]): Future[Int] = ???
    def P(x: Future[Int], y: Future[Int]): Future[Int] = ???
    def Q(x: Future[Int], y: Future[Int]): Future[Int] = ???
    }
